...
Route::prefix('admin')->middleware(['auth', 'isAdmin'])->group(function(){
    ...
    Route::get(uri:'/complaints', action: [AdminController::class, 'allComplaints'])->name(name: 'admin.all.complaints');
    Route::get(uri: '/all-pending-complaints', action: [AdminController::class, ''])->name(name: 'admin.all.pending.complaints');
});
